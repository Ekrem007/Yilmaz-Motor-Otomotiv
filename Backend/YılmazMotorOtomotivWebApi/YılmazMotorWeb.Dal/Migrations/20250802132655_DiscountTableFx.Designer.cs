...
namespace YılmazMotorWeb.Dal.Migrations
{
    ...
    [Migration("20250802132655_DiscountTableFx")]
    partial class DiscountTableFx
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("YılmazMotorWeb.Entities.Concretes.Discount", b =>
                {
                    ...
                    b.Property<bool>("IsActive")
                        ...
                        .HasColumnType("bit")
                        .HasComputedColumnSql("CASE WHEN GETDATE() BETWEEN StartDate AND EndDate THEN 1 ELSE 0 END", false);
