...
{
    [DbContext(typeof(YılmazMotorWebDbContext))]
    [Migration("20250807151309_Coupon System ")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YılmazMotorWeb.Entities.Concretes.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YılmazMotorWeb.Entities.Concretes.ProductReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YılmazMotorWeb.Entities.Concretes.UserCoupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YılmazMotorWeb.Entities.Concretes.UserTaskProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("YılmazMotorWeb.Entities.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("YılmazMotorWeb.Entities.Identity.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("YılmazMotorWeb.Entities.Concretes.OrderItem", b =>
                {
                    b.HasOne("YılmazMotorWeb.Entities.Concretes.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("YılmazMotorWeb.Entities.Concretes.Product", b =>
                {
                    b.HasOne("YılmazMotorWeb.Entities.Concretes.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("YılmazMotorWeb.Entities.Concretes.UserTaskProgress", b =>
                {
                    b.HasOne("YılmazMotorWeb.Entities.Concretes.UserCoupon", "UserCoupon")
                        .WithMany()
                    ...
                    b.HasOne("YılmazMotorWeb.Entities.Concretes.UserTask", "UserTask")
                        .WithMany()
